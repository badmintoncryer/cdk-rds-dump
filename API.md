...
| <code><a href="#cdk-rds-dump.RdsDump.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="cdk-rds-dump.RdsDump.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="cdk-rds-dump.RdsDump.with.parameter.mixins"></a>
